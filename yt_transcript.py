...
# Import all known exception types with graceful fallbacks
_OPTIONAL_ERRORS = {}
...
def _cache_path(video_id: str, languages: list) -> Path:
    """Hashed cache filename. Raw input never appears in the path."""
    canonical = json.dumps({"video_id": video_id, "languages": languages},
                           sort_keys=True)
...
def save_to_cache(video_id: str, segments: list, language: str,
    ...
    """Persist transcript with full provenance."""
